...
- Review `PKT-01_DEV-04_PMW_READ_SURFACE.md` and close the remaining UI/UX decisions for DEV-04.
- Keep the first implementation read-only and source it from the approved read model and designated summary sections.
- Preserve the 4-card rail, active detail, diagnostics secondary layer, and drawer-based artifact reading flow.
- Start PMW code only after the DEV-04 packet is approved for code.
