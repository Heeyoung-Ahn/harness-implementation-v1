...
| --- | --- | --- | --- | --- | --- |
| Planning | PLN-00 | Kickoff interview | todo | Close implementation-critical discovery and approval boundaries first. | reference/planning/PLN-00_DEEP_INTERVIEW.md |
| Planning | PLN-01 | Requirements freeze | todo | Freeze the project-specific requirements baseline. | .agents/artifacts/REQUIREMENTS.md |
