...
- `.agents/runtime/ACTIVE_CONTEXT.json` is AI-facing derived state and is never write authority.
- `.agents/runtime/ACTIVE_CONTEXT.md` is human-facing Korean derived state and is never write authority.
