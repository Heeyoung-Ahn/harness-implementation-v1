...
위 운영 규칙은 [.agents/rules/HARNESS_OPERATING_CONTRACT.md](</C:/Newface/30 Github/harness-implementation-v1/.agents/rules/HARNESS_OPERATING_CONTRACT.md>)와 workflow contract에서 다룬다.

## Authoring Flow
1. 먼저 [REQUIREMENTS.md](</C:/Newface/30 Github/harness-implementation-v1/.agents/artifacts/REQUIREMENTS.md>)를 채운다.
2. 그 다음 이 문서에서 technical architecture를 닫는다.
3. data-impact 작업이면 [DOMAIN_CONTEXT.md](</C:/Newface/30 Github/harness-implementation-v1/.agents/artifacts/DOMAIN_CONTEXT.md>)를 같이 인용한다.
4. system boundary가 중요한 작업이면 [SYSTEM_CONTEXT.md](</C:/Newface/30 Github/harness-implementation-v1/.agents/artifacts/SYSTEM_CONTEXT.md>)를 같이 인용한다.
5. 과거 rebaseline, decommission, durable decision history가 현재 architecture 판단에 영향을 주면 [PROJECT_HISTORY.md](</C:/Newface/30 Github/harness-implementation-v1/.agents/artifacts/PROJECT_HISTORY.md>)를 같이 인용한다.
